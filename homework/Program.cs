...
namespace DamerauLevenshteinHW
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("=== Домашнее задание 1: Алгоритм поиска с опечатками (Дамерау-Левенштейн) ===");
            Console.WriteLine("Для выхода введите в качестве первой строки 'exit'");
            ...
            while (true)
            {
                ...
                WriteDistance(firstInput, secondInput);
            }
        }
    }
}